        ...
        <div class="company-inner">
            ...
            <div class="company-details">
                ...
                <div class="company-additional">
					...
					<p>Kick Robotics is a startup company that works on two rover robots used in farming and warehouse management</p>
        ...
        <div class="company-inner">
            ...
            <div class="company-details">
                ...
                <div class="company-additional">
                    ...
                    <p class="justifyContent">In my experience, I've undertaken various web development projects, encompassing both back-end and front-end aspects. For back-end development, I've designed and developed websites using the MVC framework and managed databases for Wipro's Cybersecurity portal. Additionally, I've executed numerous research and development endeavors for diverse clients. On the front-end, I've led website design and development projects for internal clients, including the migration of the Wipro portal from MVC to AngularJS. Furthermore, I've specialized in Restful API development, optimizing functionality and performance by converting MVC frameworks to ASP.NET MVC. These experiences showcase my ability to deliver comprehensive web solutions across a spectrum of technologies and frameworks.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="company-inner">
            ...
            <div class="company-details">
                ...
                <div class="company-additional">
					...
					<p>UMD Robotics department is one of the best research facility in the country, where I worked on the autonomous navigating scooter.</p>
                    <p class="justifyContent">My research was focused on simulation development using Gazebo and Rviz, along with rigorous testing of ROS programming. I've also implemented advanced perception techniques, such as object detection and pose estimation with the Realsense D435 camera, particularly for optimizing scooter parking efficiency. My expertise ensures robustness and innovation in robotics solutions.</p>
                </div>
            </div>
        </div>
    </div>
